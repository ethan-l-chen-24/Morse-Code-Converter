...
set_property PACKAGE_PIN U16 [get_ports light_ext_port]					
	set_property IOSTANDARD LVCMOS33 [get_ports light_ext_port]
## LED 1
#set_property PACKAGE_PIN E19 [get_ports full_ext_port]					
	#set_property IOSTANDARD LVCMOS33 [get_ports full_ext_port]
## LED 2
...
set_property PACKAGE_PIN L1 [get_ports audio_done_ext_port]					
	set_property IOSTANDARD LVCMOS33 [get_ports audio_done_ext_port]
