...
set_property PACKAGE_PIN W5 [get_ports clk_port]
	set_property IOSTANDARD LVCMOS33 [get_ports clk_port]
	create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports clk_port]
...
#set_property PACKAGE_PIN U16 [get_ports audio_ext_port]
	#set_property IOSTANDARD LVCMOS33 [get_ports audio_ext_port]
## LED 1
...
##====================================================================
## CENTER BUTTON
set_property PACKAGE_PIN U18 [get_ports play_ext_port]						
	set_property IOSTANDARD LVCMOS33 [get_ports play_ext_port]
## UP BUTTON
...
##====================================================================
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports cs_ext_port]					
	set_property IOSTANDARD LVCMOS33 [get_ports cs_ext_port]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports data_ext_port]					
	set_property IOSTANDARD LVCMOS33 [get_ports data_ext_port]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports data_ext_port]					
	#set_property IOSTANDARD LVCMOS33 [get_ports data_ext_port]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports sclk_ext_port]					
	set_property IOSTANDARD LVCMOS33 [get_ports sclk_ext_port]
##Sch name = JB7
